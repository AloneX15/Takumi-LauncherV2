...
class Home {
        ...
        if (news) {
                    ...
                    blockNews.innerHTML = `
                        <div class="news-header">
                            ...
                            <div class="date">
                                ...
                                <div class="month">${date.month.charAt(0).toUpperCase() + date.month.slice(1)}</div>
                            </div>
                        </div>
                        <div class="news-content">
                            <div class="bbWrapper">
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>No se pudo contactar con el servidor de noticias.<br>Por favor, verifica tu configuración.</p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
    ...
    async instancesSelect() {
        ...
        for (let instance of instancesList) {
            ...
            } else console.log(`Inicializando instancia ${instance.name}...`)
